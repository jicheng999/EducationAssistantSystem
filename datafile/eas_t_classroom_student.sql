...
--
-- Table structure for table `t_classroom_student`
--
...
--
-- Dumping data for table `t_classroom_student`
--

LOCK TABLES `t_classroom_student` WRITE;
/*!40000 ALTER TABLE `t_classroom_student` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_classroom_student` ENABLE KEYS */;
UNLOCK TABLES;
