...
--
-- Table structure for table `t_assignment_class`
--
...
--
-- Dumping data for table `t_assignment_class`
--

LOCK TABLES `t_assignment_class` WRITE;
/*!40000 ALTER TABLE `t_assignment_class` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_assignment_class` ENABLE KEYS */;
UNLOCK TABLES;
